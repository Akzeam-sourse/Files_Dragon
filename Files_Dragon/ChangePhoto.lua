...
if result.id_ then 
local SOFI = DevSOFI:get("XFor:Photo"..result.id_)
if not result.profile_photo_ then 
if SOFI then 
Dev_SOFI(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevSOFI:del("XFor:Photo"..result.id_) 
end
end
...
DevSOFI:set("XFor:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
